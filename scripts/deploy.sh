...
gum spin --spinner dot --title "Packaging web and backend folders (excluding git-tracked assets)..." -- bash -c "tar --exclude='build/web/assets/hotel_assets' --exclude='*.tar.gz' -czf $OUTPUT_ARCHIVE build/web/ backend/"
